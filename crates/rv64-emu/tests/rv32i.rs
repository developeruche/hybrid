// use rv64_emu::{emu::Emu, primitives::constants::RAM_BASE};
...
//     ];
//     let expected_xregs = helper::create_xregs(vec![(16, 0x2000 + RAM_BASE)]);
//     let expected_fregs = helper::create_fregs(vec![]);
...
//     assert_eq!(20 + RAM_BASE, emu.cpu.pc);
// }
...
//     ];
//     let expected_xregs = helper::create_xregs(vec![(16, 3), (17, 5), (18, 12 + RAM_BASE)]);
//     let expected_fregs = helper::create_fregs(vec![]);
